...
EXPERIMENTS = [
    dict(
        slug="sleep-harness", name="sleep-harness", badge="results",
...
sub-vocabulary, so each step costs one small matmul per layer. As far as we can tell nobody
    ...
    dict(
        slug="evolving-robot", name="evolving-robot", badge="prototype",
...
the right to change.</p>"""),
    ...
    dict(
        slug="agentvcs", name="agentvcs", badge="reproducible",
...
layer has 20 tests while the core object store has 5.</p>"""),
    ...
    dict(
        slug="qa", name="qa", badge="prototype",
...
silently. The Chrome-extension dependency also narrows who can run it.</p>"""),
    ...
    dict(
        slug="skillos", name="skillos", badge="prototype",
...
baseline and cannot be reproduced from the repo.</p>"""),
    ...
    dict(
        slug="token-trie", name="token-trie", badge="reproducible",
...
strategic. Third, one cartridge per session — there is no registry yet.</p>"""),
    ...
    dict(
        slug="skillos-robot", name="skillos_robot", badge="prototype",
...
not been recorded.</p>"""),
    ...
    dict(
        slug="evolving-memory", name="evolving-memory", badge="results",
